                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <?php if(isset($_SESSION['login_id'])): ?>
                          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=guest_lecture">Guest Lecture</a></li>  
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=donations">Donations</a></li>
                        <?php endif; ?>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div class="modal fade" id="pay_model" role='dialog'>
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title"></h5>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id='submit' onclick="$('#pay_model form').submit()">Save</button>
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
      </div>
      </div>
    </div>
