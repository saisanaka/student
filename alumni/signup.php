                   ...
                   <div class="card mb-4">
                        <div class="card-body">
                            <div class="container-fluid">
                                <div class="col-md-12">
                                    <form action="" id="create_account" autocomplete="off">
                                        ...
                                        <div class="col-md-4">
                                                ...
                                                <select class="custom-select select2" name="designation" required>
                                                    <option></option>
                                                    <?php 
                                                    $designation = $conn->query("SELECT * FROM designation order by id asc");
                                                    while($des=$designation->fetch_assoc()):
                                                    ?>
