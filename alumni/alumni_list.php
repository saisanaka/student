        	...
        	<div class="container">
		        ...
		        <div class="card-body">
		            <div class="row">
                        ...
                        <?php 
                            $years = $conn->query("select DISTINCT batch from alumnus_bio ORDER by batch");
                            while($row = $years->fetch_assoc()):

                        ?>
                        <button class="btn btn-primary search-batch" value="<?php echo $row['batch']; ?>"><?php echo $row['batch']; ?></button>&nbsp;
                        <?php
                            endwhile;
                        ?>
		                <!-- <div class="col-md-8">
