	...
	margin:unset;
        ...
        <header class="masthead">
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end mb-4 page-title">
                        <h3 class="text-white">Guest Lecture</h3>
            ...
            <div class="container-fluid mt-3 pt-2">
                ...
                $alumni = $conn->query("SELECT a.*,c.course, d.designation as gldesignation,Concat(a.lastname,', ',a.firstname,' ',a.middlename) as name from alumnus_bio a inner join courses c on c.id = a.course_id LEFT JOIN designation d on d.id = a.designation WHERE a.designation IN ('4', '5', '6') order by Concat(a.lastname,', ',a.firstname,' ',a.middlename) asc");
                    ...
                    <div class="card-body">
                        <div class="row align-items-center h-100">
                            <div class="">
                                ...
                                <p class="filter-txt">Designation: <b><?php echo $row['gldesignation'] ?></b></p>
